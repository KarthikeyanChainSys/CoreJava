 ...
 */
@WebServlet(name ="asdsa",urlPatterns = {"/home","/vidu"}, description = "servlet for home page",
initParams = {@WebInitParam(name="phone",value="1234567890"),
		@WebInitParam(name="email",value="abc@gmail.com")})
// have more than one url pattern
